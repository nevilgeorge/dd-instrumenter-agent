...
class DocumentRetriever:
    ...
    def _extract_main_content(self, soup: BeautifulSoup) -> Optional[DocSection]:
        ...
        # Get all text content, preserving code blocks
        content_parts = []
        for element in main_content.find_all(['p', 'ul', 'ol', 'pre', 'h2', 'h3', 'h4', 'h5', 'h6']):
            if element.parent == main_content:  # Only get direct children
                if element.name == 'pre':
                    ...
                    # For headings, add extra newlines and make them more prominent
